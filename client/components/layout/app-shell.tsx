...
import { EzPilotIcon } from "@/components/icons/ez-icon";
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton
                ...
                tooltip={process.env.NEXT_PUBLIC_APP_NAME}
              >
                <EzPilotIcon className="size-8 rounded-[10px]" />
...
export function BrandMark({ className }: { className?: string }) {
  return (
    ...
    >
      <EzPilotIcon className="size-8 rounded-[10px]" />
      <span className="font-heading text-[1.05rem] leading-none">Ez</span>
    </div>
  );
}
